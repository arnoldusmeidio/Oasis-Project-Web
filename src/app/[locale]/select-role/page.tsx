                                    ...
                                    render={({ field }) => (
                                        <FormItem className="space-y-3 lg:space-y-6">
                                                    ...
                                                    <FormItem className="bg-card relative rounded-lg">
                                                        ...
                                                        <FormLabel>
                                                            <RoleSelectionCard
                                                                roleType={"Customer"}
                                                                description={
                                                                    "As a customer, you could booked the listed properties"
                                                                }
                                                    ...
                                                    <FormItem className="bg-card relative rounded-lg">
                                                        ...
                                                        <FormLabel>
                                                            <RoleSelectionCard
                                                                roleType={"Tenant"}
                                                                description={
                                                                    "As a tenant, you could rent your properties to customers"
                                                                }
                                            ...
                                            <p className="text-muted-foreground text-sm">
                                                Note: You could not change your role in the future once you choose a
                                                role
                                            </p>
                                        </FormItem>
                                    )}
