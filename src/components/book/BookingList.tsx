                                        ...
                                        <div className="grid-cols mb-4 grid items-start pb-4 last:mb-0 last:pb-0">
                                            <div className="space-y-1">
                                                <p className="text-sm font-medium leading-none">
                                                    〒 {e.room.property.name}
                                                </p>
                                                <p className="text-muted-foreground text-sm">
                                                    {e.room.property.description}
                                                </p>
                                                <p className="text-muted-foreground text-sm">
                                        ...
                                        <AlertDialog>
                                            ...
                                            <AlertDialogContent>
                                                <AlertDialogHeader>
                                                    ...
                                                    <AlertDialogDescription>
                                                        By confirming cancellation, all associated reservations will be
                                                        released. Please review our policies regarding cancellations
                                                        carefully.
                                                    </AlertDialogDescription>
                                                </AlertDialogHeader>
                                                <AlertDialogFooter>
